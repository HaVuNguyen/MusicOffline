...
public class SongAddToPlaylistAdapter extends RecyclerView.Adapter<SongAddToPlaylistAdapter.ViewHolder> {

    private List<Song> mSongs;
    private IOnClickListener mListener;

    SongAddToPlaylistAdapter(List<Song> songs, IOnClickListener listener) {
        mSongs = songs;
        mListener = listener;
    }
    ...
    void setSongToPlaylist(List<Song> songs) {
        mSongs = songs;
